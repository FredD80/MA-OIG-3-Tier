...
# ----------------------------
# DB Subnet Group (pinned to us-east-1a, us-east-1c)
# ----------------------------
...
resource "aws_db_instance" "postgres" {
  ...
  tags = merge(var.tags, { Name = "${var.name}-rds-postgres-primary", tier = "db", az = "us-east-1a" })
}
...
resource "aws_db_instance" "postgres_replica" {
  ...
  tags = merge(var.tags, { Name = "${var.name}-rds-postgres-replica", tier = "db", az = "us-east-1c" })
}
