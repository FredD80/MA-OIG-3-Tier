...
# --- Web tier (public-facing EC2 instances) ---
variable "web_instance_type" {
  type        = string
  description = "Instance type for web (public-tier) EC2 instances"
  default     = "t3.medium"
}
...
variable "app_instance_type" {
  type        = string
  description = "Instance type for app (private-tier) EC2 instances"
  default     = "t3.medium"
}
